...
- Procedural Crafting (→ You can craft tools out of any material, and the game will interpret its stats.)
- Data-Driven Content (→ Biomes, Blocks, Items, and Structures can all be created without programming knowledge.)
